...
export default function NewDosenPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.showSuccess('Berhasil', 'Dosen berhasil dibuat!');
  ...
  if (authLoading) {
    return (
      <div>
        <PageBreadcrumb pageTitle="New Dosen" />
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="New Dosen" />
      <ComponentCard title="Create New Dosen">
          ...
          <div>
            ...
            >
              ...
              {previewImage ? (
                ...
                <div className="space-y-4">
                  <img src={formData.gambar} alt="Current" className="max-w-xs mx-auto rounded-lg" />
                  <p className="text-sm text-gray-600">Klik atau drag untuk mengganti gambar</p>
                </div>
              ) : (
                <div>
