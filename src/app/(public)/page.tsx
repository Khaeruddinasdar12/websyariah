...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center overflow-hidden" style={{background: 'linear-gradient(to bottom right, rgba(var(--color-primary-rgb), 0.05), rgba(255, 255, 255, 1), rgba(var(--color-primary-light-rgb), 0.03))'}}>
        {/* Background Pattern */}
        ...
        <div className="absolute bottom-40 left-20 w-10 h-10 bg-gradient-to-br from-primary-dark/15 to-primary/15 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
            ...
            <div className="animate-fade-in">
              <div className="mb-6">
                <div className="inline-flex items-center px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full shadow-md">
                  ...
                  <span className="text-ink-800 font-medium text-sm">{t('home.accredited')}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-lg">
                  ...
                  <p className="text-ink-600 text-xs">{t('home.activeStudents')}</p>
                </div>
                <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-lg">
                  <div className="text-2xl md:text-3xl font-bold mb-1" style={{color: 'var(--color-primary)'}}>50+</div>
                  <p className="text-ink-600 text-xs">{t('home.expertLecturers')}</p>
                </div>
                <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-lg">
                  <div className="text-2xl md:text-3xl font-bold mb-1" style={{color: 'var(--color-primary)'}}>3</div>
                  <p className="text-ink-600 text-xs">{t('home.studyPrograms')}</p>
                </div>
                <div className="text-center p-3 bg-white/60 backdrop-blur-sm rounded-lg">
                  <div className="text-2xl md:text-3xl font-bold mb-1" style={{color: 'var(--color-primary)'}}>50+</div>
                  <p className="text-ink-600 text-xs">{t('home.yearsExperience')}</p>
                </div>
              </div>
            </div>
                  ...
                  <div className="relative z-10 flex items-center justify-center h-full">
                    <div className="w-full max-w-md">
                      ...
                      <div className="relative">
                        ...
                        <div className="relative bg-white rounded-3xl p-8 shadow-2xl border" style={{borderColor: 'rgba(var(--color-primary-rgb), 0.2)'}}>
                          <div className="text-center">
                            <div className="w-24 h-24 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl border-4" style={{background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-light) 100%)', borderColor: 'rgba(var(--color-primary-rgb), 0.3)'}}>
                              <i className="fas fa-user-graduate text-white" style={{display: 'block', fontSize: '2.5rem', textShadow: '0 2px 4px rgba(0,0,0,0.2)'}}></i>
                            </div>
                            <h3 className="text-xl font-bold text-ink-900 mb-2">{t('home.hero.illustrationTitle')}</h3>
                            <p className="text-ink-600 text-sm">{t('home.hero.illustrationSubtitle')}</p>
                          </div>
        ...
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 animate-bounce">
          <i className="fas fa-chevron-down text-ink-400 text-xl"></i>
        </div>
      </section>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.dean.title')}</h2>
            <div className="w-20 h-1 gradient-primary mb-6"></div>
          </div>

          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-ink-800">{t('home.dean.name')}</h3>
            <p className="text-sm text-ink-600 mb-4">{t('home.dean.position')}</p>

            <blockquote className="text-ink-800 leading-relaxed italic border-l-4 pl-6" style={{borderColor: 'var(--color-primary)'}}>
              "{t('home.dean.quote')}"
            </blockquote>
      ...
      <section id="tentang" className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-slide-up">
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.about.title')}</h2>
  ...
  {/* Card 1 */}
  <div className="text-center p-6 rounded-xl bg-gradient-to-br from-white to-cream shadow-lg card-hover group">
  <div className="w-18 h-18 rounded-2xl flex items-center justify-center mx-auto mb-4 
                  group-hover:scale-110 transition-transform duration-300 shadow-xl border-2" style={{width: '4.5rem', height: '4.5rem', background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-light) 100%)', borderColor: 'rgba(var(--color-primary-rgb), 0.4)'}}>
  ...
  <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.aboutCards.qualityEducation.title')}</h3>
  <p className="text-ink-600 text-sm leading-relaxed">
  ...
  <div className="text-center p-6 rounded-xl bg-gradient-to-br from-white to-cream shadow-lg card-hover group">
    ...
    <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.aboutCards.practicalApproach.title')}</h3>
    <p className="text-ink-600 text-sm leading-relaxed">
  ...
  <div className="text-center p-6 rounded-xl bg-gradient-to-br from-white to-cream shadow-lg card-hover group">
    ...
    <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.aboutCards.academicCommunity.title')}</h3>
    <p className="text-ink-600 text-sm leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-ink-900">{t('home.announcements.title')}</h2>
                <p className="text-ink-600 text-sm mt-1">{t('home.announcements.subtitle')}</p>
              </div>
            </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="card-soft p-5 border-l-4 animate-pulse">
                  <div className="flex items-start justify-between mb-3">
                    <div className="h-6 w-20 bg-ink-100 rounded-full"></div>
                    <div className="h-4 w-24 bg-ink-100 rounded"></div>
                  </div>
                  <div className="h-5 bg-ink-100 rounded mb-2"></div>
                  <div className="h-4 bg-ink-100 rounded"></div>
                </div>
              ))}
            </div>
          ) : pengumuman.length > 0 ? (
              ...
              {pengumuman.map((item) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span className="text-xs text-ink-500">{formatDate(item.created_at, localeMap[language])}</span>
                  </div>
                  <h4 className="font-semibold text-ink-900 mb-2 text-sm leading-tight">{item.judul}</h4>
                  <p className="text-xs text-ink-600 leading-relaxed">{createExcerpt(item.konten, 100)}</p>
                </Link>
              ))}
            </div>
          ) : (
            <div className="text-center py-12">
              <i className="fas fa-inbox text-4xl text-ink-400 mb-4"></i>
              <p className="text-ink-600">{t('announcements.noAnnouncements')}</p>
            </div>
          )}
      ...
      {/* Berita Section */}
      <section className="py-20 bg-gradient-to-br from-ink-50 to-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-ink-900">{t('home.news.title')}</h2>
                <p className="text-ink-600 text-sm mt-1">{t('home.news.subtitle')}</p>
              </div>
            </div>
          ...
          {loadingBerita ? (
            <div className="grid md:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <article key={i} className="card-soft overflow-hidden animate-pulse">
                  <div className="h-48 bg-ink-100"></div>
                  <div className="p-5">
                    <div className="h-4 w-32 bg-ink-100 rounded mb-2"></div>
                    <div className="h-5 bg-ink-100 rounded mb-2"></div>
                    <div className="h-4 bg-ink-100 rounded mb-3"></div>
                    <div className="h-4 w-24 bg-ink-100 rounded"></div>
                  </div>
                </article>
              ))}
                ...
                return (
                  ...
                  >
                    <div className="h-48 bg-gradient-to-br from-sage-green/15 to-soft-green/15 flex items-center justify-center relative overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center bg-ink-100" style={{display: item.gambar ? 'none' : 'flex'}}>
                    ...
                    <div className="p-5">
                      ...
                      <h4 className="font-semibold text-ink-900 mb-2 text-sm leading-tight">{item.judul}</h4>
                      <p className="text-xs text-ink-600 leading-relaxed mb-3">{createExcerpt(item.konten, 100)}</p>
            ...
            <div className="text-center py-12">
              <i className="fas fa-newspaper text-4xl text-ink-400 mb-4"></i>
              <p className="text-ink-600">{t('news.noNews')}</p>
            </div>
          )}
...
<section className="py-20 bg-gradient-to-br from-ink-50 to-white relative">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="text-center mb-16">
      <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.programs.title')}</h2>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      <div className="bg-white rounded-xl shadow-lg card-hover p-6 relative overflow-hidden group border border-orange-100">
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-gold/30 to-gold-light/30 rounded-full -translate-y-12 translate-x-12 opacity-40 group-hover:scale-110 transition-transform duration-300"></div>
        <div className="relative z-10">
          ...
          <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.programs.constitutionalLaw.title')}</h3>
      ...
      <div className="bg-white rounded-xl shadow-lg card-hover p-6 relative overflow-hidden group border border-blue-100">
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-primary/30 to-primary-light/30 rounded-full -translate-y-12 translate-x-12 opacity-40 group-hover:scale-110 transition-transform duration-300"></div>
        <div className="relative z-10">
          ...
          <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.programs.familyLaw.title')}</h3>
          <p className="text-ink-600 mb-4 text-sm leading-relaxed">
      ...
      <div className="bg-white rounded-xl shadow-lg card-hover p-6 relative overflow-hidden group border border-emerald-100">
        <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-primary-light/40 to-soft-green/40 rounded-full -translate-y-12 translate-x-12 opacity-40 group-hover:scale-110 transition-transform duration-300"></div>
        <div className="relative z-10">
          ...
          <h3 className="text-xl font-bold text-ink-900 mb-3">{t('home.programs.economicLaw.title')}</h3>
          <p className="text-ink-600 mb-4 text-sm leading-relaxed">
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.visionMission.title')}</h2>
            <div className="w-20 h-1 gradient-primary mx-auto mb-6"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="card-soft p-8">
              <div className="flex items-center mb-6">
                <div className="w-18 h-18 rounded-2xl flex items-center justify-center mr-4 shadow-lg" style={{width: '4.5rem', height: '4.5rem', background: 'linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-light) 100%)'}}>
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-ink-900">{t('about.vision.title')}</h3>
              </div>
              <p className="text-ink-800 leading-relaxed text-lg">
            ...
            <div className="card-soft p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-ink-900">{t('about.mission.title')}</h3>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-ink-50 to-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.facilities.title')}</h2>
            <div className="w-20 h-1 gradient-primary mx-auto mb-6"></div>
            <p className="text-lg text-ink-600 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card-soft p-6 text-center group">
              ...
              <h3 className="text-lg font-bold text-ink-900 mb-2">{t('home.facilities.library.title')}</h3>
              <p className="text-ink-600 text-sm">{t('home.facilities.library.description')}</p>
            </div>
            ...
            <div className="card-soft p-6 text-center group">
              ...
              <h3 className="text-lg font-bold text-ink-900 mb-2">{t('home.facilities.computerLab.title')}</h3>
              <p className="text-ink-600 text-sm">{t('home.facilities.computerLab.description')}</p>
            </div>
            ...
            <div className="card-soft p-6 text-center group">
              ...
              <h3 className="text-lg font-bold text-ink-900 mb-2">{t('home.facilities.discussionRoom.title')}</h3>
              <p className="text-ink-600 text-sm">{t('home.facilities.discussionRoom.description')}</p>
            </div>
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.testimonials.title')}</h2>
            <div className="w-20 h-1 gradient-primary mx-auto mb-6"></div>
            <p className="text-lg text-ink-600 max-w-2xl mx-auto leading-relaxed">
          ...
          >
            <SwiperSlide>
              <div className="bg-gradient-to-br from-white to-cream rounded-2xl p-6 md:p-8 shadow-lg h-full flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="font-bold text-ink-900 text-base">{t('home.testimonialItems.putra.name')}</h4>
                    <p className="text-xs text-ink-600 leading-tight mt-1">{t('home.testimonialItems.putra.role')}</p>
                  </div>
                </div>
                ...
                <p className="text-ink-900 leading-relaxed text-sm md:text-base flex-1" style={{color: '#1f2937', lineHeight: '1.75'}}>
            ...
            <SwiperSlide>
              <div className="bg-gradient-to-br from-white to-cream rounded-2xl p-6 md:p-8 shadow-lg h-full flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="font-bold text-ink-900 text-base">{t('home.testimonialItems.ahmad.name')}</h4>
                    <p className="text-xs text-ink-600 leading-tight mt-1">{t('home.testimonialItems.ahmad.role')}</p>
                  </div>
                </div>
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => (
            ...
            <SwiperSlide>
              <div className="bg-gradient-to-br from-white to-cream rounded-2xl p-6 md:p-8 shadow-lg h-full flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="font-bold text-ink-900 text-base">{t('home.testimonialItems.vivin.name')}</h4>
                    <p className="text-xs text-ink-600 leading-tight mt-1">{t('home.testimonialItems.vivin.role')}</p>
                  </div>
                </div>
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => (
            ...
            <SwiperSlide>
              <div className="bg-gradient-to-br from-white to-cream rounded-2xl p-6 md:p-8 shadow-lg h-full flex flex-col">
                <div className="flex items-center mb-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="font-bold text-ink-900 text-base">{t('home.testimonialItems.taufiq.name')}</h4>
                    <p className="text-xs text-ink-600 leading-tight mt-1">{t('home.testimonialItems.taufiq.role')}</p>
                  </div>
                </div>
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => (
      ...
      {/* Stats Section */}
<section className="py-20 relative overflow-hidden" style={{background: 'linear-gradient(135deg, var(--color-primary-dark) 0%, var(--color-primary) 60%, var(--color-primary-light) 100%)'}}>
  <div className="absolute inset-0 bg-white/5"></div>
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    <div className="grid md:grid-cols-4 gap-8 text-center">
      <div className="group">
        <div className="text-4xl font-bold text-white mb-3 group-hover:scale-110 transition-transform duration-300">1566</div>
        <p className="text-white/85 text-base">{t('home.stats.activeStudents')}</p>
      </div>
      <div className="group">
        <div className="text-4xl font-bold text-white mb-3 group-hover:scale-110 transition-transform duration-300">50+</div>
        <p className="text-white/85 text-base">{t('home.stats.expertLecturers')}</p>
      </div>
      <div className="group">
        <div className="text-4xl font-bold text-white mb-3 group-hover:scale-110 transition-transform duration-300">3</div>
        <p className="text-white/85 text-base">{t('home.stats.studyPrograms')}</p>
      </div>
      <div className="group">
        <div className="text-4xl font-bold text-white mb-3 group-hover:scale-110 transition-transform duration-300">50+</div>
        <p className="text-white/85 text-base">{t('home.stats.yearsExperience')}</p>
      </div>
    </div>
  </div>
</section>
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-ink-900 mb-4">{t('home.partnership.title')}</h2>
            <div className="w-20 h-1 gradient-primary mx-auto mb-6"></div>
            <p className="text-lg text-ink-600 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6">
            {/* Lapas */}
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              <div className="w-20 h-20 bg-ink-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary/10 transition-colors overflow-hidden relative">
                <Image 
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.lapas')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.kejaksaan')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.pengadilanNegeri')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.pengadilanAgama')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.peradi')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.bsi')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.kemenag')}</h3>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-ink-200 p-6 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center group">
              ...
              <h3 className="text-sm font-semibold text-ink-900 text-center">{t('home.partnership.baznas')}</h3>
            </div>
          </div>
        </div>
      </section>
